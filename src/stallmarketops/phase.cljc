(ns stallmarketops.phase
  "Phase 0->3 staged rollout for the ISIC-4789 'Retail sale via stalls
  and markets of other goods' operations-coordination actor.
  ...
  rollout milestone still to come. Flagging a compliance concern always
  needs a human to actually look at it. `stallmarketops.governor`'s own
  `always-escalate-ops` enforces the same invariant independently -- two
  layers, not one, agree on this."
  (:require [stallmarketops.governor :as governor]))
